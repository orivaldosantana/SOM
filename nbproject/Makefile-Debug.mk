...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/som

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/som: ${OBJECTFILES}
...
${OBJECTDIR}/Sample.o: Sample.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sample.o Sample.cpp
...
${OBJECTDIR}/TestArduino.o: TestArduino.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestArduino.o TestArduino.cpp
